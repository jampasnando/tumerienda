...
Route::post('/reset-password', [AuthController::class, 'resetearPassword']);
...
Route::get("/tutor/resumen/{id}",[\App\Http\Controllers\BeneficiarioTutorController::class,'resumen']);
